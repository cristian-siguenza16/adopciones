...
export class InitDatabase1708447756241 implements MigrationInterface {
    name = 'InitDatabase1708447756241'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."dogs_genero_enum" AS ENUM('Macho', 'Hembra')`);
        await queryRunner.query(`CREATE TABLE "dogs" ("id" SERIAL NOT NULL, "raza" character varying(255) NOT NULL, "nombre" character varying(255) NOT NULL, "edad" character varying(255) NOT NULL, "peso" character varying(255) NOT NULL, "genero" "public"."dogs_genero_enum" NOT NULL, "userId" integer, CONSTRAINT "PK_c0911b1d44db6cdd303c6d6afc9" PRIMARY KEY ("id"))`);
